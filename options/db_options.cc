...
ImmutableDBOptions::ImmutableDBOptions(const DBOptions& options)
    : create_if_missing(options.create_if_missing),
      ...
      enable_flash_admission_list(options.enable_flash_admission_list),
      enable_flash_evict_blocks(options.enable_flash_evict_blocks),
      enable_flash_prefetch_files(options.enable_flash_prefetch_files),
      block_cache(options.block_cache),
      secondary_cache(options.secondary_cache) {
