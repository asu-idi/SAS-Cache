...
struct DBOptions {
  ...
  bool enable_flash_admission_list = false;

  bool enable_flash_evict_blocks = false;

  bool enable_flash_prefetch_files = false;

  // store the block cache's pointer
...
struct ReadOptions {
  ...
  // Options: whether to get these blocks , are used by all kinds of get block functions
  // 
  // Default: false
  bool get_index_block;
  bool get_filter_block;
  bool get_del_range_block;
