...
std::shared_ptr<rocksdb::SecondaryCache> NewRocksCachelibWrapper(unsigned long flash_cache_size) {
  ...
  return std::shared_ptr<rocksdb::SecondaryCache>(new RocksCachelibWrapper(
