...
class TableReader {
 public:
  ...
  virtual Status GetBlocksInOneFile(GetContext*) {
      return Status::NotSupported();
    }

  virtual Status GetBlockKeysInOneFile(std::vector<CacheKey>&) {
      return Status::NotSupported();
    }

  virtual Status GetBlocksWithKeyRange(GetContext*, const Slice&, const Slice&, bool, bool) {
      return Status::NotSupported();
    }

  virtual Status GetIndexBlock(GetContext*) {
      return Status::NotSupported();
    }

  // virtual Status GetIndexBlock(const ReadOptions&, GetContext*) {
  //     return Status::NotSupported();
  //   }

  virtual Status GetFilterBlock(GetContext*) {
      return Status::NotSupported();
    }

  virtual Status GetDelRangeBlock(GetContext*) {
      return Status::NotSupported();
    }
