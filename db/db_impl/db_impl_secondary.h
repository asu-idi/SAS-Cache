...
class DBImplSecondary : public DBImpl {
 public:
  ...
  Status GetBlockInLevel(const ReadOptions& read_options,
                  ColumnFamilyHandle* column_family, const Slice& key, uint64_t level,
                  std::vector<Slice>& block_contents) override;

  Status GetBlockInLevelRange(const ReadOptions& read_options,
                  ColumnFamilyHandle* column_family, const Slice& key, uint64_t low_level, uint64_t high_level,
                  std::vector<Slice>& block_contents) override;

  Status GetAllBlocksInLevel(const ReadOptions& read_options,
                  ColumnFamilyHandle* column_family, uint64_t level,
                  std::vector<Slice>& block_contents) override;

  Status GetBlockInKeyRange(const ReadOptions& read_options,
