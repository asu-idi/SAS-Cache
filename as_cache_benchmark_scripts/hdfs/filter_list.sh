logpath="/data/caoz/program/tmp/as_cache_benchmark_results/hdfs/filter/50M/1M/test"

# hdfs dfs -rm -r /tmp/existing_db

# ../../build/db_bench --benchmarks="readrandomwriterandom,stats" --use_direct_io_for_flush_and_compaction=true --use_direct_reads=true --cache_index_and_filter_blocks=true --perf_level=2 --key_size=48 --value_size=10240 --readwritepercent=50 --cache_size=268435456 --statistics --use_local_flash_cache=false --db=/tmp/existing_db --flash_cache_size=512 --num=1000000 --use_flash_cache_filter=false --enable_flash_admission_list=false --dram_cache_size=8 >$logpath/50_256.txt

hdfs dfs -rm -r /tmp/existing_db

../../build/db_bench --benchmarks="readrandomwriterandom,stats" --use_direct_io_for_flush_and_compaction=true --use_direct_reads=true --cache_index_and_filter_blocks=true --perf_level=2 --key_size=48 --value_size=10240 --readwritepercent=50 --cache_size=268435456 --statistics --use_local_flash_cache=true --db=/tmp/existing_db --flash_cache_size=5120 --num=1000000 --use_flash_cache_filter=false --enable_flash_admission_list=false --dram_cache_size=8 >$logpath/50_256_5G.txt

hdfs dfs -rm -r /tmp/existing_db

../../build/db_bench --benchmarks="readrandomwriterandom,stats" --use_direct_io_for_flush_and_compaction=true --use_direct_reads=true --cache_index_and_filter_blocks=true --perf_level=2 --key_size=48 --value_size=10240 --readwritepercent=50 --cache_size=268435456 --statistics --use_local_flash_cache=true --db=/tmp/existing_db --flash_cache_size=1024 --num=1000000 --use_flash_cache_filter=true --enable_flash_admission_list=true --dram_cache_size=8 >$logpath/50_256_1G_list_filter.txt

# hdfs dfs -rm -r /tmp/existing_db

# ../../build/db_bench --benchmarks="readrandomwriterandom,stats" --use_direct_io_for_flush_and_compaction=true --use_direct_reads=true --cache_index_and_filter_blocks=true --perf_level=2 --key_size=48 --value_size=10240 --readwritepercent=50 --cache_size=268435456 --statistics --use_local_flash_cache=true --db=/tmp/existing_db --flash_cache_size=5120 --num=1000000 --use_flash_cache_filter=false --enable_flash_admission_list=true --dram_cache_size=8 >$logpath/50_256_5G_list.txt

# hdfs dfs -rm -r /tmp/existing_db

# ../../build/db_bench --benchmarks="readrandomwriterandom,stats" --use_direct_io_for_flush_and_compaction=true --use_direct_reads=true --cache_index_and_filter_blocks=true --perf_level=2 --key_size=48 --value_size=10240 --readwritepercent=50 --cache_size=268435456 --statistics --use_local_flash_cache=true --db=/tmp/existing_db --flash_cache_size=5120 --num=1000000 --use_flash_cache_filter=true --enable_flash_admission_list=false --dram_cache_size=8 >$logpath/50_256_5G_filter.txt

hdfs dfs -rm -r /tmp/existing_db

../../build/db_bench --benchmarks="readrandomwriterandom,stats" --use_direct_io_for_flush_and_compaction=true --use_direct_reads=true --cache_index_and_filter_blocks=true --perf_level=2 --key_size=48 --value_size=10240 --readwritepercent=50 --cache_size=268435456 --statistics --use_local_flash_cache=true --db=/tmp/existing_db --flash_cache_size=5120 --num=1000000 --use_flash_cache_filter=true --enable_flash_admission_list=true --dram_cache_size=8 >$logpath/50_256_5G_list_filter.txt
